...
if __name__ == '__main__':
    ...
    while frame_num <= args.n_frames:
        ...
        #paddle detect
        dets = cnn_face_detector.face_detection([cv2_frame])
        print(dets)
        ...
        for idx, det in enumerate(dets):
            ...
            x_min = det["data"][0]["left"]
            y_min = det["data"][0]["top"]
            x_max = det["data"][0]["right"]
            y_max = det["data"][0]["bottom"]
            conf = det["data"][0]["confidence"]
